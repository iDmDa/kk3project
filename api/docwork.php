...
function findlist($find) {
    ...
    if($find != null and $find != "" and $find != "undefined") {
        $fieldForSearch = "naimenovenie, date, numstage, otd, fio, codnorm, normativtruda, prim";
...
$stmt = $pdo->prepare("SELECT COUNT(*) as total FROM docwork WHERE doctype = 0 and hide = 0 {$filter} AND detid = :detid");
